...

{
    ...
    public class Parameters
    {
        ...
        private void ValidateParameters()
        {
            ...
            {
                if (AllParameters.TryGetValue(ParameterType.HandleWidth, 
                    out chainedParameterFirst) == true ||
                    AllParameters.TryGetValue(ParameterType.RodLength, 
                    out chainedParameterSecond) == true)
                {
                    ...
                    if (AllParameters.TryGetValue(ParameterType.RodLength, 
                        out chainedParameterSecond) == true &&
            ...
            {
                if (AllParameters.TryGetValue(ParameterType.HandleLength, 
                    out chainedParameterFirst) == true ||
                    AllParameters.TryGetValue(ParameterType.RodWidth, 
                    out chainedParameterSecond) == true)
                {
                    ...
                    if (AllParameters.TryGetValue(ParameterType.RodWidth, 
                        out chainedParameterSecond) == true)
                    {
